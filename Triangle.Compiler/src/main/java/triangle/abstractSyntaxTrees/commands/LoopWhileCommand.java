...
/**
 * Loop-While-Do command: executes the body at least once, then repeats while condition is true
...
public class LoopWhileCommand extends Command {
	...
	public final Command C1;  // Body executed at least once
	public Expression E;      // Condition to check
	public final Command C2;  // Body executed while condition is true
}
